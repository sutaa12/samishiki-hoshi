...
| R2-G2 Shared foundation | RenderFeature, deterministic WorldPlan, named seed streams, Linear HDR, warm-up, temporal ownership, metrics, provenance | in progress: GFX-002 implementation `2cfaafb` / evidence `9f3286d` and GFX-003 implementation `c024566` / evidence `a4bcfdf` accepted with S0–S3=0; GFX-004–006 remain pending |
