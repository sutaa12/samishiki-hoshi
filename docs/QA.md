...
| R2-G1 Renderer spike | WebGPURenderer + TSL; actual WebGPU and forced-WebGL2 telemetry; no simulation changes | in progress: `8ead154` automated paths pass, but independent audit requires disposal/error-observability and evidence-binding remediation |
...
- GFX-001 renderer spike under remediation: `8ead1545b6235eaaba5cf05e0319bea858bcefb1`; independent audit S0=0, S1=2, S2=3, S3=1; evidence record `docs/evidence/GFX-001.md`.
